...
A detailed description of the component's purpose, when to use it, and its key features. Medium complexity components typically have 6-15 props with moderate logic.
...
- State changes (loading, disabled) are communicated
...
**Use Case:** Form submission with loading state
...
**Spacing:**
- `m-2`, `mt-2`, `mb-2` - Margin utilities
- `p-2`, `pt-2`, `pb-2` - Padding utilities
- `me-2`, `ms-2` - Horizontal margins
...
- All color variants work with all style variants
- Icons are loaded from Tabler Icons package
- Component automatically handles RTL layouts
- Loading state includes built-in spinner
