{{--
    ...
    Displays logo and optional company name in navbar.
    ...
    - small (bool) - Use small logo variant (default: false)
    ...
    <a href="{{ $href }}" aria-label="{{ $name }}">
        ...
        @elseif($slot->isEmpty())
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 68 68" width="32" height="32"
                 aria-label="{{ $name }}" class="navbar-brand-image">
